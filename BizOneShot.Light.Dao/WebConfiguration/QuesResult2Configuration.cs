...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    ...
    internal partial class QuesResult2Configuration : EntityTypeConfiguration<QuesResult2>
    {
        ...
        public QuesResult2Configuration(string schema)
        {
            ...
            Property(x => x.D).HasColumnName("D").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(100);
            Property(x => x.D451).HasColumnName("D-1").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(100);
            Property(x => x.D452).HasColumnName("D-2").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(100);
            Property(x => x.D453).HasColumnName("D-3").IsOptional().IsUnicode(false).HasColumnType("varchar").HasMaxLength(100);
